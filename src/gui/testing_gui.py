...
class TestingGUI:
    ...
    def update(self, screen, main_player, movable_tiles):
        ...
        movable_tiles_label = self.main_font.render(f'Tile Info: movable[{main_player.tile_y}][{main_player.tile_x}] = {movable_tiles[main_player.tile_y][main_player.tile_x]}', False, (0, 0, 0))
