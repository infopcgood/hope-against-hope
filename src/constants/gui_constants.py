...
OPTIONS_UI_SELECTION_COLOR = (42, 42, 42, 176)
OPTIONS_UI_LIGHT_SELECTION_COLOR = (74, 74, 74, 176)
OPTIONS_UI_BACKGROUND_ALPHA = 176
OPTIONS_UI_BACKGROUND_COLOR = (84, 84, 84)
OPTIONS_UI_TAB_IDS = ['status', 'save', 'quit']
OPTIONS_UI_TAB_DEPTH = [1, 2, 2]
OPTIONS_UI_TAB_OPTIONS = [0, 3, 2]
...
OPTIONS_UI_CONTENT_START_CORNER = (72 + 224 + 16, 72)
OPTIONS_UI_MENU_TEXT_LINE_HEIGHT = 42
OPTIONS_UI_SAVE_MENU_HEIGHT = 84
OPTIONS_UI_CONTENT_SELECTION_WIDTH = 640
