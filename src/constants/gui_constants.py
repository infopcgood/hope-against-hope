...
DIALOGUE_FONT_FILENAME = "fonts/Malgun Gothic Regular.ttf"
DIALOGUE_GUI_FONT_SIZE = 20

TESTING_GUI_FONT_FILENAME = "fonts/Malgun Gothic Regular.ttf"
TESTING_GUI_FONT_SIZE = 20
